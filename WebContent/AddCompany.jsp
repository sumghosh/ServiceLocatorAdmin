...
function submit_form(id){
	...
	//alert(document.getElementById('type_of_add').value);
	document.getElementById('addComp').submit();
}
/*function openTechPopUp(curr_obj){
	...
	$(curr_obj).siblings().attr("clicked",true);
}*/
...
<div class="col-sm-8 col-md-12 col-lg-12 col-xs-12 main rightnav">
  <h1 class="page-header_content" style="margin-left:20px;">Add Company</h1>
  ...
  <form id="addComp" class="form-horizontal" data-toggle="validator" role="form" method="post" action="saveCompany">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" id="name" name="name" class="form-control" placeholder="Input the name" required>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" id="complocid" name="complocid" class="form-control" placeholder="Input company location id" required>
                </div>
                <c:choose>
                	<c:when test="${not empty Error1001}">
                		<span class=""><c:out value="${Error1001}"></c:out></span>
                	</c:when>
                	<c:otherwise>
                		<span class="help-block">LS MDM id</span>
                	</c:otherwise>
                </c:choose>
                </div>
          ...
          <div class="row" style="margin:20px;">
            <div class="form-group">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  <div class="input-group-addon"> <span class="glyphicon glyphicon-map-marker"></span> </div>
                  <input type="text" id="addressline1" name="addressline1" class="form-control" placeholder="street address" required>
                </div>
            ...
            <div class="form-group has-success">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  <div class="input-group-addon"> <span class="glyphicon glyphicon-map-marker"></span> </div>
                  <input type="text" id="addressline2" name="addressline2" class="form-control" placeholder="supplimentary address">
                </div>
