...
<div class="col-sm-8 col-md-12 col-lg-12 col-xs-12 main rightnav">
  ...
  <form id="addXMLFeed" class="form-horizontal" method="post" action="saveXMLFeed">
            ...
            <div class="form-group has-success">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                    ...
                    <input type="text" id="xml_file_name" name="xml_file_name" class="form-control" readonly>
                    </div>
                   <script>
