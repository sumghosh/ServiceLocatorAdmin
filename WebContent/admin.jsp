...
<div id="content-main">
        ...
        <table>
            <tr>
                <td>
<form id="myform" method="post" action="companies">
  	<input type="hidden" name="jdbc_query" value="value" /> 
  	<a href="#" onclick="document.getElementById('myform').submit();"><strong>Companies</strong></a>
</form>            
                </td>
                <td><a href="/kyadmin/service_locator/company/add/" class="addlink">Add</a></td>
            

            
                <td><a href="/kyadmin/service_locator/company/" class="changelink">Change</a></td>
            
            </tr>
        
            <tr>
            <td>
<form id="prodform" method="post" action="admin/products">
  	<input type="hidden" name="jdbc_query" value="value" /> 
  	<a href="#" onclick="document.getElementById('prodform').submit();"><strong>Products</strong></a>
                ...
                <td><a href="/kyadmin/service_locator/product/add/" class="addlink">Add</a></td>
            

            
                <td><a href="/kyadmin/service_locator/product/" class="changelink">Change</a></td>
            
            </tr>
        
            <tr>
            
                <th scope="row"><a href="/kyadmin/service_locator/technician/">Technicians</a></th>
            

            
                <td><a href="/kyadmin/service_locator/technician/add/" class="addlink">Add</a></td>
            

            
                <td><a href="/kyadmin/service_locator/technician/" class="changelink">Change</a></td>
            
            </tr>
        
            <tr>
            
                <th scope="row"><a href="/kyadmin/service_locator/training/">Training</a></th>
            

            
                <td><a href="/kyadmin/service_locator/training/add/" class="addlink">Add</a></td>
            

            
                <td><a href="/kyadmin/service_locator/training/" class="changelink">Change</a></td>
            
            </tr>
        
            <tr>
            
                <th scope="row"><a href="/kyadmin/service_locator/xmlfeed/">Xml feeds</a></th>
            

            
                <td><a href="/kyadmin/service_locator/xmlfeed/add/" class="addlink">Add</a></td>
            

            
                <td><a href="/kyadmin/service_locator/xmlfeed/" class="changelink">Change</a></td>
