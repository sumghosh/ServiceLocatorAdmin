...
function getCompId(compid){
	//alert('inside getCompId' + compid);
	window.opener.$('[clicked=true]').val(compid);
	window.close();
}
...
<div class="col-sm-8 col-md-12 col-lg-12 col-xs-12 main rightnav">
  <div class="row col-sm-6 col-md-12 col-lg-12"> <span class="header_top" style="margin-left:20px;">Company Details</span>
    <div style="float:right; margin-top:7px;">
      <a type="button" value="Search" class="btn btn-success" href="addCompany">Add Company</a>
    </div>
  ...
  <div class="panel_search panel-default col-sm-4 col-md-11 col-lg-11" style="margin-left:20px;">
    <form id="company-search" action="" method="get">
      ...
      <div class="form-group_search col-sm-6 col-md-2 col-lg-2">
        <a type="button" value="Search" class="btn btn-success" onclick="document.getElementById('company-search').submit();">SEARCH</a>
      </div>
      <div class="form-group_search col-sm-6 col-md-5 col-lg-5">
        ...
        <span class="help-block">Filter by country</span> </div>
    </form>
  </div>
   	<div class="container-fluid col-sm-4 col-md-12 col-lg-12">
        <ul class="pagination pagination-sm pagination-lg pagination-sm pagination-md gen">
            <li>
            ...
            <li><c:forEach begin="1" end="${noOfPages}" var="i">
            		...
            		<c:otherwise>
                        <li class="gen"><a href="CompanyDetails?page=${i}&q=${searchtext}">${i}</a></li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            </li>
    ...
    <div class="table-responsive">
      <table id="result_list" class="table table-hover" style="overflow-x:auto;">
        ...
        <th scope="col" class="warning gen"><input type="checkbox" id="selectall">
          ...
          <th scope="col" class="warning gen"><a href="CompanyDetails?q=${searchtext}&o=1">Name</a>
            <div class="clear"></div>
          </th>
          <th scope="col" class="warning gen"><a href="CompanyDetails?q=${searchtext}&o=2">Location id</a>
            <div class="clear"></div>
          </th>
          <th scope="col" class="warning gen"><a href="CompanyDetails?q=${searchtext}&o=3">Phone</a>
            <div class="clear"></div>
          </th>
          <th scope="col" class="warning gen"><span>Address</span>
            <div class="clear"></div>
          </th>
          <th scope="col" class="warning gen"><a href="CompanyDetails?q=${searchtext}&o=5">Country</a>
            <div class="clear"></div>
          </th>
        ...
        <tbody>
          <c:forEach var="Company" varStatus="loopStatus" items="${companies}">
				<tr id="comprow" class="${loopStatus.index % 2 == 0 ? 'success' : 'row1'}">
					...
					<td><a class="gen" href="#" onClick="javascript:getCompId(${Company.id});"><c:out value="${Company.compName}"></c:out></a></td>
					...
					<td><c:out value="${Company.compAddress.country}"></c:out></td>
