...
<div class="col-sm-4 col-md-12 main">
  <h1 class="page-header_content" style="margin-left:20px;">Login Error</h1>
      ...
      <div class="panel panel-success" style="margin-top:20px;">
        ...
        <div class="panel-body">
          <div class="row" style="margin:20px;">  
            ...
            <span class="edit">You have successfully logged into Google but you don't have access to this application. If you need access please contact system administrator.</span>
            <span class="help-block"><a href="Login.jsp" class="gen">Log in again</a></span>            
