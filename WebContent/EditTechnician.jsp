...
function submit_form(id){
	...
	document.getElementById('edittech').action = 'UpdateTechnician?techid=${technician.id}';
	document.getElementById('edittech').submit();
}
$(document).ready(function(){
    $("div#region_selector select option").each(function(){
        if($(this).val()=="${technician.techAddress.region}"){
...
$(document).ready(function(){
    $("div#country_selector select option").each(function(){
        if($(this).val()=="${technician.techAddress.country}"){
            $(this).attr("selected","selected");    
        }
    });
});
$(document).ready(function() {
        ...
        $("#add_training").click(function() {
	    	if(count1 == 0){
	    		$('#new_training_info').show();
	    		count1++;
	    	}else{
	    		$('#new_training_info:last').clone(true).insertAfter('#new_training_info:last');
	    		//$('#mytable tbody>tr>td>input:last').val("");
	    	}
	        return false;
        });
...
<!-- Content Area Starts -->
 <div class="col-sm-8 col-md-12 col-lg-12 col-xs-12 main rightnav">
  <h1 class="page-header_content" style="margin-left:20px;">Edit Technician</h1>
  <div class="bs-example gen">
    <ul class="breadcrumb ">
      <li><a href="dashboard.jsp">Home</a></li>
      <li><a href="TechnicianDetails">Technicians</a></li>
      <li class="active">Edit Technician</li>
    </ul>
  </div>
  <form id="edittech" class="form-horizontal" data-toggle="validator" method="post" action="">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" id="first_name" name="first_name" value="${technician.firstName}" class="form-control" placeholder="Input first name" required>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  <div class="input-group-addon"> <span class="glyphicon glyphicon-user"></span> </div>
                  <input type="text" id="last_name" name="last_name" value="${technician.lastName}" class="form-control" placeholder="Input last Name" required>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  <div class="input-group-addon"> <span class="glyphicon glyphicon-user"></span> </div>
                  <input type="text" id="user_id" name="user_id" value="${technician.userId}" class="form-control" placeholder="User Id" required>
                </div>
            ...
            <div class="form-group has-success">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" id="phone" name="phone" value="${technician.phone}" class="form-control" placeholder="phone">
                </div>
              </div>
            </div>
            <div class="form-group has-success">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" id="email" name="email" value="${technician.email}" class="form-control" placeholder="email">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row" style="margin:20px;">
            <div class="form-group">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" id="address1" name="address1" value="${technician.techAddress.addressLine1}" class="form-control" placeholder="street address" required>
                </div>
            ...
            <div class="form-group has-success">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  <div class="input-group-addon"> <span class="glyphicon glyphicon-map-marker"></span> </div>
                  <input type="text" id="address2" name="address2" value="${technician.techAddress.addressLine2}" class="form-control" placeholder="supplimentary address">
                </div>
            ...
            <div class="form-group">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" id="city" name="city" value="${technician.techAddress.city}" class="form-control" placeholder="city" required>
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-xs-9 col-md-4">
                <div class="input-group">
                  <div class="input-group-addon"> <span class="lyphicon glyphicon-picture"></span> </div>
                  <input type="text" id="postalcode" name="postalcode" value="${technician.techAddress.postalCode}" class="form-control" placeholder="Postal Code" required>
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-9 col-md-4">
                  <div class="input-group">
                    <div class="input-group-addon"> <span class="glyphicon glyphicon-map-marker"></span> </div>
                    <input class="form-control inputSuccess" placeholder="street address" id="lat" name="lat" step="1e-7" type="number" value="${technician.techAddress.latitude}" required>
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-xs-9 col-md-4">
                  <div class="input-group">
                    <div class="input-group-addon"> <span class="glyphicon glyphicon-map-marker"></span> </div>
                    <input class="form-control inputSuccess" placeholder="street address" id="lng" name="lng" step="1e-7" type="number" value="${technician.techAddress.longitude}" required>
                  </div>
                </div>
              </div>
              <div class="form-group has-success">
                ...
                <div class="col-xs-9 col-md-4">
                  <input type="text" id="address_hash" name="address_hash" value="${technician.techAddress.addressHash}" class="form-control" placeholder="address hash">
                </div>
              ...
              <div class="form-group has-success">
                ...
                <div class="col-xs-9 col-md-4">
                  <input type="text" id="location_type" name="location_type" value="${technician.techAddress.locationType}" class="form-control" placeholder="location type">
                </div>
              ...
              <div class="form-group has-success">
                ...
                <div class="col-xs-9 col-md-4">
                  <div class="input-group date" id="datetimepicker1">
                  	<!--<fmt:parseDate value="${technician.techAddress.geocodedOn}" type="BOTH" var="parsedDate" pattern="yyyy-MM-dd" />-->
                    <input type="text" class="form-control" id="geocoded_on" name="geocoded_on" value="${technician.techAddress.geocodedOn}" readonly/>
              ...
              <script type="text/javascript">
                                $(function () {
                                    ...
                                    $('#datetimepicker1').datetimepicker(type.format);
                                });
              </script>  -->
              ...
              <table class="table table-hover">
                <tbody>
                  ...
                  <tr id="training_info" class="info">
                    ...
                    <td class="col-xs-9 col-md-4">
                    	<div class="input-group  has-success">
                            ...
                            <select class="form-control" id="certification_type" name="certification_type">
                              	<c:if test="${Training.type == 'h'}">
                              		<option value="h" selected="selected">Gold Certification</option>
                              	</c:if>
                              	<c:if test="${Training.type == 'o'}">
                    ...
                    <td>
                    	<a class="glyphicon glyphicon-remove gen" style="padding-left:25px; padding-top:10px;" type="button" onClick="TrainingRowDelete(this);"></a>
                    </td>
                  </tr>
                  </c:forEach>
                  <tr id="new_training_info" style="display: none; class="info">
                    <td class="col-xs-9 col-md-4"><div class="input-group  has-success">
                    	<div class="input-group-addon"> <span class="glyphicon glyphicon-globe"></span> </div>
                            <select class="form-control" id="product_id" name="product_id">
            ...
            <td colspan="2" class="col-sm-12 col-md-12 col-lg-12 col-xs-12" id="addTable">
              <table border="0" style="display: none; margin-bottom:0px;" id="mytable" width="100%">
                <tr>
                  ...
                  <td>
                  	<a href="#"  class="glyphicon glyphicon-remove gen" style="margin-left:auto;" type="button" onclick="SomeDeleteRowFunction(this);"></a>
                  </td>
                </tr>
              </table>
            </td>
